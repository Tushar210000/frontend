...
export default function Empjansewa() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formData.income_certificate) fd.append("income_certificate", formData.income_certificate);
      if (formData.ration_id) fd.append("ration_id", formData.ration_id);
      if (formData.caste_certificate) fd.append("caste_certificate", formData.caste_certificate);

      const res = await fetch("https://backendnow-pem2.onrender.com/api/services/janarogya/employee/apply", {
        method: "POST",
        headers: {
